...
namespace SistemaInventario.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        //agegamos la variable para el rol de usuario
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                //var user = CreateUser();
                //generamos nuestro propio modelo
                ...
                if (result.Succeeded)
                {
                    ...
                    //para asignar el rol de usuario debemos de saber si existe  o  no
                    ...
                    //le asignamos un rol al usuario y depues lo cambiamos
